...
<div class="page-container">
	<form class="form form-horizontal" id="form-friend-add" action="/admin/friend/add" method="POST">
		<div class="row cl">
			...
			<div class="formControls col-md-11 col-xs-9 col-sm-10">
				<input type="text" class="input-text" placeholder="请输入友情标题" name="title">
			</div>
		</div>
        <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-md-11 col-xs-9 col-sm-10">
				<input type="text" class="input-text" placeholder="请输入超链接地址" name="url">
			</div>
		</div>
		<div class="row cl">
